...
<head>
	...
	<title>Communication from <?= $servername; ?></title>
	<style type="text/css">
    ...
    <table cellpadding="0" cellspacing="0" border="0" id="backgroundTable" bgcolor="#eceff1" width="100%">
    	<tr>
    		...
    		<table class="main-content" cellpadding="0" cellspacing="0" border="0" align="center" style="width: 650px; text-align: left; color: #424648;">
    				        ...
    				        <tr>
    				            <td valign="middle" height="120" style="text-align: center; font-size: 48px; font-weight: 100;">
    				            	<a href="<?= $this->Html->url('/', true); ?>">
	    				            	<img src="<?= $this->Html->url('/', true); ?>Userfiles/Settings/Images/<?= md5(Me::teamId()); ?>/Logo?time=<?= time(); ?>" alt="Go to home page" class="logo" style="max-height: <?= $theme['maxLogoHeight'] ?>px;" />
    				            	</a>
    				            </td>
    				        </tr>
    				    </table>
    			...
    			<!-- FOOTER -->
    			<tr>
    			    <td valign="middle" height="60" style="color: #7d8488; text-align: center;">
    			        <span style="font-size: 12px;">You have received this email because you have an account on <a href="http://www.boost-appstore.com/" style="font-weight: bold; text-decoration: underline; color: #424648;">Boost Enterprise AppStore</a>.
    			    </td>
    			</tr>
    		</table>
